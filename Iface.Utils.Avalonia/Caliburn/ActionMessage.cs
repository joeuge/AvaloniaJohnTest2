...
namespace Caliburn.Micro
{
    ...
    using DependencyObject = global::Avalonia.AvaloniaObject;
    using UIElement = global::Avalonia.Input.InputElement;
    using DependencyPropertyChangedEventArgs = global::Avalonia.AvaloniaPropertyChangedEventArgs;
    using DependencyProperty = global::Avalonia.AvaloniaProperty;
...
#endif
    public class ActionMessage : TriggerAction<Control>, IHaveParameters
    {
        ...
        void ElementLoaded(object sender, RoutedEventArgs e)
        {
            ...
            if (context.View == null)
            {
                ...
                while (currentElement != null)
                {
                    ...
                    {
                      var johnNext = currentParent.GetVisualParent();
                      if (johnNext != null)
                      {
                        currentParent = johnNext;
                      }
                    }
                    //if (currentParent != null)
                    //{
        ...
        public static Action<ActionExecutionContext> PrepareContext = context =>
        {
            ...
            if (guard == null)
            {
                ...
                handler = (s, e) =>
                {
                    ...
                    {
                        global::Caliburn.Micro.Execute.OnUIThread(() =>
                        {
